...
def get_predictions(image_data, model):
        ...
        prediction = model.predict(img_reshape).argmax(axis=-1)
        return prediction
...
if file is None:
    ...
    class_id = label_map_keys[label_map_values.index(prediction)]
    
    st.write("## \nThe picture here contains: ", labels[class_id])

st.write("\nBy Anweshan Mukherjee")